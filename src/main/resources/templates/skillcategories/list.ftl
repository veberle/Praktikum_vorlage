...
<main class="max-w-7xl mx-auto p-6">
  <div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-semibold text-gray-800">Skill-Kategorien</h1>
    <a href="/skillcategories/new"
       class="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">Neue Kategorie</a>
  </div>
      ...
      <#list categories as c>
        <tr class="hover:bg-gray-50">
          ...
          <td class="px-4 py-3 text-right">
            <a href="/skillcategories/${c.id}/edit" class="inline-flex items-center rounded-md bg-white px-3 py-1.5 text-xs font-medium text-gray-700 border border-gray-300 hover:bg-gray-50">Bearbeiten</a>
            <form method="post" action="/skillcategories/${c.id}/delete" class="inline ml-2"
